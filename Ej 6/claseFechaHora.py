class FechaHora:
    ...
    def __gt__(self, fechahora):
        return ((self.__dia, self.__mes, self.__año, self.__hora, self.__min, self.__seg) > (fechahora.getDia(), fechahora.getMes(), fechahora.getAño(), fechahora.getHora(), fechahora.getMin(), fechahora.getSeg()))
